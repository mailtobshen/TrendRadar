...
def _load_report_config(config_data: Dict) -> Dict:
    ...
    max_news_per_source_env = _get_env_int("MAX_NEWS_PER_SOURCE_PER_KEYWORD")
    ...
    return {
        ...
        "MAX_NEWS_PER_SOURCE_PER_KEYWORD": max_news_per_source_env or report_config.get("max_news_per_source_per_keyword", 0),
    }
